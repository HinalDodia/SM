...
import { LayoutDashboard, CandlestickChart, GitCompare, Coins, TrendingUp, BookOpen, Newspaper, Layers, FileSearch, Radar } from 'lucide-react';
...
<div className="layout">
        ...
        <div className="stock-sidenav">
          <NavLink to={`/stock/${symbol}`} className="nav-item"><LayoutDashboard className="w-4 h-4 inline-block mr-2 mb-0.5" /> Overview</NavLink>
          <NavLink to={`/chart/${symbol}`} className="nav-item"><CandlestickChart className="w-4 h-4 inline-block mr-2 mb-0.5" /> Price Action</NavLink>
          <NavLink to={`/stock/${symbol}/competitors`} className="nav-item"><GitCompare className="w-4 h-4 inline-block mr-2 mb-0.5" /> Peer Compare</NavLink>
          <NavLink to={`/dividend/${symbol}`} className="nav-item"><Coins className="w-4 h-4 inline-block mr-2 mb-0.5" /> Dividends</NavLink>
          <NavLink to={`/earnings/${symbol}`} className="nav-item"><TrendingUp className="w-4 h-4 inline-block mr-2 mb-0.5" /> Earnings</NavLink>
          <NavLink to={`/financials/${symbol}`} className="nav-item"><BookOpen className="w-4 h-4 inline-block mr-2 mb-0.5" /> Fundamentals</NavLink>
          <NavLink to={`/news/${symbol}`} className="nav-item"><Newspaper className="w-4 h-4 inline-block mr-2 mb-0.5" /> News Feed</NavLink>
          <NavLink to={`/options/${symbol}`} className="nav-item"><Layers className="w-4 h-4 inline-block mr-2 mb-0.5" /> Options Desk</NavLink>
          <NavLink to={`/sec/${symbol}`} className="nav-item"><FileSearch className="w-4 h-4 inline-block mr-2 mb-0.5" /> Disclosures</NavLink>
          <NavLink to={`/shortinterest/${symbol}`} className="nav-item"><Radar className="w-4 h-4 inline-block mr-2 mb-0.5" /> Short Radar</NavLink>
          <button onClick={handleBuyClick} className="nav-item buy-item w-full text-left" style={{ cursor: "pointer", border: "none", outline: "none", fontWeight: "bold" }}>BUY STOCK</button>
        </div>
  {/* ⭐ CLOSED SIDEBAR */}
